<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
    <a class="navbar-brand me-lg-5" href="../../index.html">
        <img class="navbar-brand-dark" src="assets/img/favicon.ico"/> <img
        class="navbar-brand-light" src="assets/img/favicon.ico"/>
    </a>
...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    ...
    <!-- Sidebar menulist -->
        <ul class="nav flex-column pt-3 pt-md-0 m-0">
        <li class="nav-item">
            <a href="index.php" class="nav-link d-flex align-items-center">
            <span class="sidebar-icon">
                <img src="assets/img/favicon.ico" height="20" width="20" alt="Volt Logo">
            </span>
            <span class="mt-1 ms-1 sidebar-text">Beach & Fun</span>
            </a>
        </li>
        <!-- Dashboard -->
        ...
        <li class="nav-item <?php echo ($_GET['include'] == 'gameplan') ? 'active' : ''; ?>">
            <a href="spielplan" class="nav-link d-flex justify-content-between">
                <span>
                    ...
                    <span class="sidebar-text">Spielplan</span>
                </span>
            <!-- New Symbol
                        <span>
        ...
        <li class="nav-item d-flex justify-content-center"> 
                <span class="badge badge-sm bg-secondary ms-1 text-gray-800">v1.0</span>
        <li class="nav-item">
